        ...
        <section className="content__element about-me" id="about-me">
            ...
            <div className="about-me__about">
                <div className="about-me__info">
                    ...
                    <p className="about-me__description">Я родился в городе Минск. В детстве увлекался футболом и плаванием. На данный момент решил начать заниматься разработкой и созданием сайтов.</p>
                ...
                <img className="about-me__avatar" src="https://sun9-50.userapi.com/impg/nmq2_u9CE73kSiXneB02uFS5QphJaiC4XA3Uig/yO1sq7R__Ds.jpg?size=1200x1600&quality=95&sign=ab927f018846c6a643bfc1001066740c&type=album" alt={`${props.name}-avatar`}/>
            </div>
            <Portfolio></Portfolio>
        </section>  
    )
